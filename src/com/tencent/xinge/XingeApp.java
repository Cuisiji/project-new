...
public class XingeApp {
	...
	public static void main(String[] args) {
		XingeApp xinge = new XingeApp(2100207125, "db2f1752e1b6f36b0bb427b69a16e00d");
		Message message = new Message();
		message.setTitle("测试");
		message.setContent("content");
		message.setType(Message.TYPE_MESSAGE);
		message.setExpireTime(86400);
		System.out.println("Hello xg!"+xinge.pushAllDevice(0, message));
	...
	//queryPushStatus	查询群发消息推送状态。可查全量设备推送和按tag推送，可批量查询多条群发消息的状态
